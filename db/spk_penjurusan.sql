...
--
-- Host: 127.0.0.1
-- Generation Time: 26 Jan 2016 pada 14.22
-- Versi Server: 5.6.20
-- PHP Version: 5.5.15
...
(7, 'MINAT', 103, 0.03),
(8, 'PSIKOTES', 101, 0.08),
(10, 'PSIKOTES', 102, 0.03),
(11, 'PSIKOTES', 103, 0.01);
...
--
-- Struktur untuk view `nilai_pembobotan_kriteria`
--
...
--
ALTER TABLE `matapelajaran_guru`
MODIFY `id_matapelajaran_guru` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=21;
--
...
--
ALTER TABLE `nilai`
MODIFY `id_nilai` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=83;
--
